...
let faveColors = ['orange', 'purple', 'black']// CODE HERE
...
let me = {
    firstName: 'Aysa',
    superHeroName: 'Healer',
    homeTown: 'Orem',
    superPowers: ['healing', 'super hearing', 'talking to animals'],
    superPowerXP: me.Math.floor(Math.random() * 100) + 1,
...
let homeTown = 'me.homeTown'// CODE HERE
