...
colorCopy.push('purple')//Code Here
...
let filtered = myNumbers.filter(myFunctionTwo)

function myFunctionTwo(num){
	return num > 100
}
// Code Here
...
let total = myNumbers.reduce(myFunctionThree)

function myFunctionThree(total, num){
	return total + num
}// Code Here
...
// let myNumbersIndex = myNumbers.forEach(myFunctionFour)

function myFunctionFour(num){
	return num.forEach
}// Code Here
...
let forTheLoveOfGeorge = notGeorge.map(myFunction)
...
let enemies = people.filter(myFunctionTwo)
...
let totallyAwesome = people.reduce(myFunctionThree)
